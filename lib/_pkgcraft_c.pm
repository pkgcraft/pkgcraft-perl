...
my $MIN_VERSION = version->parse('0.0.7');
my $MAX_VERSION = version->parse('0.0.7');
...
# Cpv support
$ffi->attach('pkgcraft_cpv_category' => ['dep_t'] => 'c_str');
$ffi->attach('pkgcraft_cpv_cmp' => ['dep_t', 'dep_t'] => 'int');
$ffi->attach('pkgcraft_cpv_cpn' => ['dep_t'] => 'c_str');
